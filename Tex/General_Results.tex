...
{\color{incolor}In [{\color{incolor}16}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{HTML}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}484}]:} \PY{n}{HTML}\PY{p}{(}\PY{l+s}{\PYZsq{}\PYZsq{}\PYZsq{}}
          ...
          \PY{l+s}{    \PYZlt{}a href=\PYZsh{}FoodFeedOtherAcross\PYZgt{}2. Spatial Coverage\PYZlt{}/a\PYZgt{}\PYZlt{}br\PYZgt{}}
          \PY{l+s}{    \PYZlt{}a href=\PYZsh{}FoodFeedOtherWithin\PYZgt{}3. Temporal Coverage\PYZlt{}/a\PYZgt{}\PYZlt{}br\PYZgt{}\PYZlt{}br\PYZgt{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}484}]:} <IPython.core.display.HTML object>
\end{Verbatim}
...
terms of how much food each produced. 68\% of all the food came from 20
to 100 ha and 200 to 1000 ha farm sizes.

This study also measures what percentage of each farm size class's crop
producion goes towards food, feed, processing, seed, waste, or other.
The farm size category with the largest percentage of food produced
compared to other cateogories within thier farm size group, are from 100
to 1000 ha, where 70\% of thier crop production goes towards food.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}480}]:} \PY{n}{df\PYZus{}within}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}480}]:}                     Feed      Food     Other  Processing      Seed     Waste
          Farm\_Sizes                                                                  
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{General_Results_files/General_Results_16_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{General_Results_files/General_Results_18_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{General_Results_files/General_Results_22_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{General_Results_files/General_Results_31_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{General_Results_files/General_Results_33_0.png}
    \end{center}
    { \hspace*{\fill} \\}
